...
<div class="footer">
    <p>© ${new Date().getFullYear()} University of Benin — UNIBEN Journal of Science, Technology and Innovation. • Crossref DOIs • Google Scholar-ready • Preserved via PKP PN</p>
</div>`;
...
.header {
    color: #0c2342;
    border-bottom: 2px solid #0c2342;
    padding-bottom: 10px;
    margin-bottom: 20px;
}
.content {
