...
<body>
    ...
    <div class="content">
        ...
        <p>We are pleased to invite you to become a reviewer for the University of Benin Journal of Science, Technology and Innovation (UBJSTI). Your expertise in your field would be invaluable to our peer-review process, helping us to ensure the quality and integrity of the research we publish.</p>
        
        <p>As a reviewer, you will play a crucial role in evaluating manuscript submissions, providing constructive feedback to authors, and contributing to the advancement of knowledge in Science, Technology and Innovation.</p>
