...
class CitationService {
  ...
  generateAPA(
    ...
    let citation = `${authorStr} (${year}). ${article.title}. UNIBEN Journal of Science, Technology and Innovation, ${volume.volumeNumber}(${issue.issueNumber})`;
  ...
  generateMLA(
    ...
    let citation = `${authorStr}. "${article.title}." UNIBEN Journal of Science, Technology and Innovation, vol. ${volume.volumeNumber}, no. ${issue.issueNumber}, ${article.publishDate.getFullYear()}`;
  ...
  generateChicago(
    ...
    let citation = `${authorStr}. "${article.title}." UNIBEN Journal of Science, Technology and Innovation ${volume.volumeNumber}, no. ${issue.issueNumber} (${article.publishDate.getFullYear()})`;
...
${authorLines}
TI  - ${article.title}
T2  - UNIBEN Journal of Science, Technology and Innovation
