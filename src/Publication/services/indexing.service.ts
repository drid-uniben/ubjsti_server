...
class IndexingService {
  ...
  generateGoogleScholarMetaTags(
    ...
    tags.push(
      '<meta name="citation_journal_title" content="UNIBEN Journal of Science, Technology and Innovation">'
    );
...
${doiXML}
    ...
    <dc:source>UNIBEN Journal of Science, Technology and Innovation, Vol. ${volume.volumeNumber}, No. ${issue.issueNumber}</dc:source>
    </oai_dc:dc>
  </metadata>
</record>`;
  }
    ...
    const data = {
      ...
      isPartOf: {
        ...
        isPartOf: {
          ...
          isPartOf: {
            '@type': 'Periodical',
            name: 'UNIBEN Journal of Science, Technology and Innovation',
